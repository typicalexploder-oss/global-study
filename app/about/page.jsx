  ...
  return (
    <main className="relative overflow-hidden bg-[#F7F9FC] text-[#07182B] transition-colors duration-500 dark:bg-[#06121F] dark:text-white">
        ...
        <div className="container-custom relative z-10">
          <Reveal>
            <div className="max-w-5xl">
              ...
              <p className="mt-8 max-w-3xl text-base leading-8 text-black/65 transition-colors duration-500 dark:text-white/65 sm:text-lg md:text-xl md:leading-9">
                Global Study Abroad Consultants helps students discover
                world-class education opportunities across leading international
                destinations. From career-focused counselling to university
                admissions and visa support, we guide students at every stage of
      ...
      <section className="relative bg-[#F7F9FC] px-5 py-20 text-[#07182B] transition-colors duration-500 dark:bg-[#06121F] dark:text-white md:px-6 md:py-28">
        <div className="container-custom grid gap-12 md:gap-20 lg:grid-cols-2 lg:items-center">
          <Reveal>
            <div>
              ...
              <p className="mt-6 text-base leading-8 text-black/60 dark:text-white/60 sm:text-lg">
                We believe every student deserves access to quality global
                education opportunities regardless of background. Our mission is
                to simplify the study abroad process with honest guidance,
                transparency, and personalized support.
              </p>

              <p className="mt-6 text-base leading-8 text-black/60 dark:text-white/60 sm:text-lg">
                From choosing the right destination to preparing for life
                abroad, our team supports students and families with clarity and
                confidence.
              </p>
            </div>
          </Reveal>
              ...
              <div className="space-y-8">
                {[
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#07182B] dark:text-white">
                        {title}
                      </h3>

                      <p className="mt-2 leading-7 text-black/60 dark:text-white/60">
                        {text}
                      </p>
                    </div>
                  </div>
