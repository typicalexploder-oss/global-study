          ...
          <Reveal>
            <div className="max-w-5xl">
              ...
              <p className="mt-8 max-w-3xl text-base leading-8 text-white/65 sm:text-lg md:text-xl md:leading-9">
                Discover internationally recognized programs across leading study
                destinations with strong academic foundations, career opportunities,
                and global exposure.
              </p>
            </div>
          </Reveal>
            ...
            {courses.map((course, index) => (
              ...
              >
                <Link href={`/courses/${course.slug}`}>
                  <motion.div
                    whileHover={{ y: -6 }}
                    className="group cursor-pointer rounded-[2.5rem] border border-black/5 bg-white p-8 shadow-[0_20px_80px_rgba(0,0,0,0.08)] transition duration-500"
                  >
          ...
          <Reveal>
            <div>
              ...
              <p className="mt-8 text-base leading-8 text-black/60 sm:text-lg">
                ...
                education, strong career pathways, and modern student experiences
            ...
            >
              <div className="relative z-10 max-w-4xl">
                ...
                <p className="mt-6 max-w-2xl text-base leading-8 text-white/65 sm:text-lg">
                  Connect with our expert counsellors and explore internationally
                  recognized academic programs tailored to your goals.
                </p>
