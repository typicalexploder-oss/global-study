...
export default function ContactCTA() {
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-gradient-to-br from-[#06121F] via-[#081A2E] to-[#1A1028] px-5 py-20 text-white md:px-6 md:py-32"
    >
      {/* GLOWS */}
      ...
      <div className="container-custom relative z-10 grid gap-12 lg:grid-cols-2 lg:items-center md:gap-20">
        {/* LEFT CONTENT */}
        <Reveal>
          <div>
            ...
            <div className="mt-12 flex flex-wrap gap-4 md:mt-14 md:gap-6">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -4 }}
                  className="rounded-[2rem] border border-white/10 bg-white/[0.04] px-6 py-5 shadow-[0_10px_50px_rgba(0,0,0,0.3)] backdrop-blur-2xl transition duration-500 hover:border-[#F5A623]/20 hover:bg-white/[0.06] md:px-8 md:py-6"
                >
                  <h3 className="text-3xl font-black text-white md:text-4xl">
                    {value}
                  </h3>

                  <p className="mt-2 text-xs uppercase tracking-[0.25em] text-white/50 sm:text-sm">
                    {label}
                  </p>
                </motion.div>
              ))}
        ...
        <Reveal delay={0.15}>
          <motion.form
            ...
            className="group relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.05] p-6 shadow-[0_25px_100px_rgba(0,0,0,0.45)] backdrop-blur-3xl md:rounded-[3rem] md:p-10"
          >
            {/* SHINE */}
            ...
            <div className="relative z-10">
              <div className="mb-8 md:mb-10">
                ...
                <h3 className="mt-3 text-3xl font-black tracking-[-0.03em] md:text-4xl">
              ...
              <div className="grid gap-4 md:gap-5">
                {/* NAME */}
                <div>
                  <label className="mb-2 block text-xs uppercase tracking-[0.2em] text-white/40 sm:text-sm">
                    Student Name
                  </label>
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-4 text-white outline-none transition placeholder:text-white/30 focus:border-[#F5A623]/40 focus:bg-white/[0.08] md:px-5"
                  />
                </div>
                ...
                <div>
                  ...
                  <select className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-4 text-white outline-none transition focus:border-[#F5A623]/40 focus:bg-white/[0.08] md:px-5">
                    <option className="bg-[#06121F]">
                      Select Country
                    </option>
