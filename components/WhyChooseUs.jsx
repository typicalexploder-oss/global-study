...
export default function WhyChooseUs() {
  return (
    <section
      id="about"
      className="relative overflow-hidden bg-gradient-to-b from-[#140D2E] via-[#081B34] to-[#071527] px-6 py-32 text-white"
    >
      {/* GLOWS */}
            ...
            <div className="mt-12 flex flex-wrap gap-6">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -5 }}
                  className="group rounded-[2rem] border border-white/10 bg-white/[0.04] px-8 py-6 shadow-[0_10px_50px_rgba(0,0,0,0.25)] backdrop-blur-xl transition duration-500 hover:border-[#F5A623]/20 hover:bg-white/[0.07]"
                >
          ...
          {features.map((feature, index) => (
            ...
            >
              <motion.div
                ...
                className="group relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.04] p-8 shadow-[0_15px_70px_rgba(0,0,0,0.3)] backdrop-blur-2xl transition duration-500 hover:border-[#F5A623]/20 hover:bg-white/[0.07]"
              >
                {/* SHINE EFFECT */}
                ...
                <div className="relative z-10">
                  {/* ICON */}
                  <div className="mb-7 flex h-18 w-18 items-center justify-center rounded-[1.7rem] border border-[#F5A623]/20 bg-[#F5A623]/10 text-4xl shadow-[0_0_60px_rgba(245,166,35,0.2)] backdrop-blur-xl">
                    {feature.icon}
                  </div>
